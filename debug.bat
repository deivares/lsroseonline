...
xcopy C:\Rose\irose\bin\debug\trose.exe C:\Rose\irose\game\ /y
xcopy C:\Rose\irose\bin\debug\triggervfs.dll C:\Rose\irose\game\ /y
xcopy C:\Rose\irose\bin\debug\znzin.dll C:\Rose\irose\game\ /y
