...
const __int64 MAX_TRADE_MONEY = 1000000000;///±≥»ØΩ√ √÷¥Î ∞≈∑° µ∑
...
bool CTCmdMoveItemInv2Bank::Exec( CTObject* pObj )
{
	...
	if( bPlatinum )///¿œ∫ª¿Ã æ∆¥—∞ÊøÏ «√∑°∆º≥— ≈«¿∫ «√∑°∆º≥— ªÁøÎ¿⁄∏∏ π∞∞«¿ª ≥÷¿ªºˆ ¿÷¥Ÿ.
	{
...
///*-----------------------------------------------------------------------------------------------*/
//TODO criar validaÁ„o para valor de venda do item n„o ser maior que o valor de compra ja com os desonctos do bg aplicados - evitar efeito rose br
bool CTCmdAddItem2DealFromInventory::Exec( CTObject* pObj )
{
	///pObj¥¬ Icon»§¿∫ Item¿Ã ø√ºˆ ¿÷¥Ÿ.
	if( pObj == NULL )
	{
