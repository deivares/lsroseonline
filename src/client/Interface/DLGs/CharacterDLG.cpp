...
void CCharacterDLG::DrawBasicInfo()
{
	...
	///이름
	::drawFont( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 59,67, D3DCOLOR_XRGB( 255, 255, 255 ),  g_pAVATAR->Get_NAME() );		
	///클래스(직업)
	...
	//레벨	
	::drawFontf( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 59,172, D3DCOLOR_XRGB( 255, 255, 255 ), "%d", g_pAVATAR->Get_LEVEL());		
	//경험치	
...
void CCharacterDLG::DrawAbilityInfo()
{
	...
	///힘
	::drawFontf( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 58, 67, D3DCOLOR_XRGB( 255, 255, 255), "%d",g_pAVATAR->Get_STR());		
	///민첩
	::drawFontf( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 58, 88, D3DCOLOR_XRGB( 255, 255, 255), "%d",g_pAVATAR->Get_DEX());		
	///지력
	::drawFontf( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 58,109, D3DCOLOR_XRGB( 255, 255, 255), "%d",g_pAVATAR->Get_INT());		
	///집중
	::drawFontf( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 58,130, D3DCOLOR_XRGB( 255, 255, 255), "%d",g_pAVATAR->Get_CON());
	///매력
	::drawFontf( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 58,151, D3DCOLOR_XRGB( 255, 255, 255), "%d",g_pAVATAR->Get_CHARM());
	///감각
	::drawFontf( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 58,172, D3DCOLOR_XRGB( 255, 255, 255), "%d",g_pAVATAR->Get_SENSE());
	...
	///포인트
	::drawFontf( g_GameDATA.m_hFONT[ FONT_NORMAL ], true, 69,211, D3DCOLOR_XRGB( 255, 255, 255),"%d", g_pAVATAR->Get_BonusPOINT());			
}
